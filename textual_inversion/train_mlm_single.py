...
def main():
    ...
    if accelerator.is_main_process:
        ...
        shutil.copy('clip_src/modeling_clip.py {}/clip_src/modeling_clip.py'.format(codepath),follow_symlinks=True)
        shutil.copy('clip_src/modeling_outputs.py {}/clip_src/modeling_outputs.py'.format(codepath),follow_symlinks=True)
        # copy clip
