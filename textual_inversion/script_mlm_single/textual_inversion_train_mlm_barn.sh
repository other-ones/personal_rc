...
accelerate launch --main_process_port 4234  textual_inversion_train_mlm_single.py \
  ...
  --lr_warmup_steps=0 \
  --output_dir="saved_models/single/barn" \
  --seed=7777 \
  --mask_tokens="[MASK]" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00005_barn' \
  --scale_lr \
...
accelerate launch --main_process_port 4235  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm0001_barn' \
  --scale_lr \
  --prompt_type='building' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 4236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00025_barn' \
  --scale_lr \
  --prompt_type='building' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 4236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_no_mlm_barn' \
  --scale_lr \
  --prompt_type='building' \
  --include_prior_concept=0 
