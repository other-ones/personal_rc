...
accelerate launch --main_process_port 4234  train_mlm_single.py \
  ...
  --lr_warmup_steps=0 \
  --output_dir="saved_models/tmp/dog6" \
  --seed=7777 \
  --mask_tokens="[MASK]" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='tmp_ti_noprior_mlm00005_dog6' \
  --scale_lr \
  --prompt_type='pet' \
...
accelerate launch --main_process_port 4235  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm0001_dog6' \
  --scale_lr \
  --prompt_type='pet' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 4236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00025_dog6' \
  --scale_lr \
  --prompt_type='pet' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 4236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_no_mlm_dog6' \
  --scale_lr \
  --prompt_type='pet' \
  --include_prior_concept=0 
