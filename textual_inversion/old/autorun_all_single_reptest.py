...
for rep_id in rep_ids:
    if include_prior:
        dir_name='single_acc4_prior_seed{}_reptest_bigger_qlab{}'.format(seed,host_suffix)
    else:
        dir_name='single_acc4_noprior_seed{}_repest_bigger_qlab{}'.format(seed,host_suffix)
                    ...
                    for cidx,concept in enumerate(list(info_map.keys())):
                        ...
                        for lambda_mlm in lambda_mlm_list:
                            ...
                            while True:
                                ...
                                time.sleep(delay)
                            print(f"TRAIN RUNNING {dir_name}\t{run_name}\tDEVICE:{device_idx}")
