...
accelerate launch --main_process_port 4232  ti_train_clean.py \
  ...
  --placeholder_token1="<man_dog1_man>" \
  --train_prior_concept1="man" \
  --eval_prior_concept1="man " \
  --resolution=512 \
  --train_batch_size=4 \
  ...
  --lr_warmup_steps=0 \
  --output_dir="saved_models/ti_models/custom/man_dog1" \
  --seed=7777 \
  --mask_tokens="[MASK]" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=25 \
  --run_name='man_dog1_man_mlm0001_living' \
  --scale_lr \
  --train_prompt_type='man' \
...
accelerate launch --main_process_port 4234  ti_train_clean.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=25 \
  --run_name='man_dog1_man_nomlm_living' \
  --scale_lr \
  --train_prompt_type='man' \
  --eval_prompt_type='living' \
  --include_prior_concept=1 \
