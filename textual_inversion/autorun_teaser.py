...
if train_batch_size==4:
    ...
    assert False
if include_prior:
    dir_name='bigger_reduced{}_prior_seed{}_qlab{}_rep{}'.format(train_batch_size,resume_seed,host_suffix,rep_id)
else:
    dir_name='bigger_reduced{}_noprior_seed{}_qlab{}_rep{}'.format(train_batch_size,resume_seed,host_suffix,rep_id)
    ...
    for cidx,concept in enumerate(concepts):
        ...
        for exp_idx,exp in enumerate(exps):
            if '_rev' in exp:
                ...
                rev=0
            if not ('mlm00001' in exp or 'nomlm' in exp):
                continue
            ...
            output_dir=os.path.join('results/teasers/{}_seed{}/ti_results/{}/{}'.format(benchmark,gen_seed,dir_name,concept))
