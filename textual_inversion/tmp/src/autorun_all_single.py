...
info_map_03={
    'clock':('clock','nonliving','nonliving'),
...
if include_prior:
    dir_name='single_capv6_prior_seed{}_rep{}'.format(seed,rep_id)
else:
    dir_name='single_capv6_noprior_seed{}_rep{}'.format(seed,rep_id)
        ...
        for mask_prob in mask_prob_list:
            ...
            for cidx,concept in enumerate(list(info_map.keys())):
                ...
                for lambda_mlm in lambda_mlm_list:
                    ...
                    command+='--caption_root="../datasets_pkgs/captions/v6" \\\n'
                    command+='--run_name="{}" \\\n'.format(run_name)
