...
accelerate launch --main_process_port 4202  ti_train_clean.py \
  --pretrained_model_name_or_path=$MODEL_NAME \
  --train_data_dir1=$DATA_DIR \
  --learnable_property="object" \
  --placeholder_token1="<boy_car_boy>" \
  --train_prior_concept1="boy" \
  --eval_prior_concept1="boy" \
  --resolution=512 \
  --train_batch_size=4 \
  ...
  --lr_warmup_steps=0 \
  --output_dir="saved_models/ti_models/custom/boy_car_boy" \
  --seed=7777 \
  --mask_tokens="[MASK]" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=25 \
  --run_name='boy_car_boy_mlm0001_nonliving' \
  --scale_lr \
  --train_prompt_type='boy' \
...
accelerate launch --main_process_port 4231  ti_train_clean.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=25 \
  --run_name='boy_car_boy_nomlm_nonliving' \
  --scale_lr \
  --train_prompt_type='boy' \
  --eval_prompt_type='living' \
  --include_prior_concept=1 \
