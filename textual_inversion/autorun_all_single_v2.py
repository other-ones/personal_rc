...
include_prior=1
delay=25
mask_prob_list=[0.1,0.2,0.3,0.15,0.25]
rev_list=[0]
rep_id=1
...
if include_prior:
    dir_name='single_minmask_capv7_prior_seed{}_rep{}'.format(seed,rep_id)
else:
    dir_name='single_minmask_capv7_noprior_seed{}_rep{}'.format(seed,rep_id)
        ...
        for mlm_target in mlm_target_list:
            ...
            for cidx,concept in enumerate(list(info_map.keys())):
                ...
                for lambda_mlm in lambda_mlm_list:
                    ...
                    command+='accelerate launch --main_process_port {} ti_train_v2.py \\\n'.format(ports[cidx])
