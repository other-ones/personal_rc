...
if train_batch_size==4:
    ...
    assert False
if include_prior:
    dir_name='gclip_reduced{}_prior_seed{}_qlab{}_rep{}'.format(train_batch_size,seed,host_suffix,rep_id)
else:
    dir_name='gclip_reduced{}_noprior_seed{}_qlab{}_rep{}'.format(train_batch_size,seed,host_suffix,rep_id)
            ...
            for mlm_target in mlm_target_list:
                for lambda_mlm in lambda_mlm_list:
                    ...
                    for mask_prob in mask_prob_list:
                        ...
                        prefix='ti_gclip_qlab{}'.format(host_suffix)
                        if include_prior:
                            prefix+='_prior'
                        else:
                            prefix+='_noprior'
                        ...
                        command+='accelerate launch --main_process_port {} ti_train_gclip.py \\\n'.format(ports[cidx])
