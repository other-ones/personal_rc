...
accelerate launch --main_process_port 4230  ti_train_clean.py \
  ...
  --lr_warmup_steps=0 \
  --output_dir="saved_models/ti_models/single_acc4_noprior_seed7777_rep1_qlab03" \
  --seed=7777 \
  --mask_tokens="[MASK]" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=10 \
  --run_name='tmp_ti_qlab03_noprior_mlm0001_dog6_mprob015_mbatch25_mtarget_masked' \
  --scale_lr \
