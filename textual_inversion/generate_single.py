...
def main(args):
    ...
    if args.prompt_type=='nonliving':
        ...
        [
            "Photo of {} flower".format(placeholder),
            "{} flower growing in the desert".format(placeholder),
            "{} flower at a beach with a view of the seashore".format(placeholder),
            "{} flower on top of a mountain with sunrise in the background".format(placeholder),
            "a bouquet of {} flower".format(placeholder),
            "A garden of {} flower".format(placeholder),
            "{} flower in a violet vase on a table".format(placeholder),
            "a vase filled with {} flower on a table".format(placeholder),
            "Bouquet of {} flower and roses".format(placeholder),
            "{} flower and a chocolate cake on the table".format(placeholder),
            "{} flower oil painting ghibli inspired".format(placeholder),
            "{} flower painting by artist claude monet".format(placeholder),
            "A digital illustration of {} flower".format(placeholder),
            "Georgia O'Keeffe style {} flower painting".format(placeholder),
            "a watercolor painting of {} flower and a teapot on the table".format(placeholder),
            "{} flower with violet color petals".format(placeholder),
            "a sky blue color {} flower".format(placeholder),
            "a red color {} flower".format(placeholder),
            "Dried up {} flower".format(placeholder),
            "a dahlia flower in the style of {} flower".format(placeholder),
            ]
