            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if global_step % args.validation_steps == 0:
                        ...
                        validation_files=sorted(os.listdir(args.instance_data_dir))
                        validation_target=Image.open(os.path.join((args.instance_data_dir),validation_files[0])).resize((512,512)).convert('RGB')
