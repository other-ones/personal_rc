    ...
    for dir in dirs:
        ...
        for concept in concepts:
            ...
            for exp in exps:
                ...
                dst_path=os.path.join(exp_path,'masked_dino.json')
                if os.path.exists(dst_path):
                    read_data=json.load(open(dst_path))
                    print('{}\t{}'.format(exp_path,read_data['masked_dino']))
                    continue
                ...
                dst_file=open(os.path.join(exp_path,'masked_dino.json'),'w')
                dst_data={'masked_dino':float(score)}
