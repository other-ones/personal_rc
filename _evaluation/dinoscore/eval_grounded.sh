...
python eval.py \
--fake_root='../../results/single/wooden_pot/tiv2_no_mlm_wooden_pot_with_keyword_s3000/masked' \
--real_root="/data/twkim/diffusion/personalization/collected/masked/wooden_pot/"
...
python eval.py \
--fake_root='../../results/single/backpack/tiv2_no_mlm_backpack_with_keyword_s3000/masked' \
--real_root="/data/twkim/diffusion/personalization/collected/masked/backpack/"
...
import CUDA_VISIBLE_DEVICES=7;
python eval.py \
--fake_root='../../results/single/pet_dog1/tiv2_no_mlm_pet_dog1_with_keyword_s3000/masked' \
--real_root="/data/twkim/diffusion/personalization/collected/masked/pet_dog1/"
...
import CUDA_VISIBLE_DEVICES=7;
python eval.py \
--fake_root='../../results/single/pet_cat1/tiv2_no_mlm_pet_cat1_with_keyword_s3000/masked' \
--real_root="/data/twkim/diffusion/personalization/collected/masked/pet_cat1/"
...
import CUDA_VISIBLE_DEVICES=7;
python eval.py \
--fake_root='../../results/single/barn/tiv2_no_mlm_barn_with_keyword_s3000/masked' \
--real_root="/data/twkim/diffusion/personalization/collected/masked/barn/"
