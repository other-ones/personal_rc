...
def main():
    ...
    text_encoder, optimizer, lr_scheduler,cls_net,train_dataloader_mlm_multi = accelerator.prepare(
        text_encoder, optimizer, lr_scheduler,cls_net,train_dataloader_mlm_multi
    )
