...
accelerate launch --main_process_port 1234  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00005_rc_car' \
  --scale_lr \
...
accelerate launch --main_process_port 1235  textual_inversion_train_mlm_single.py \
  --pretrained_model_name_or_path=$MODEL_NAME \
  --train_data_dir1=$DATA_DIR \
  --learnable_property="object" \
  --placeholder_token1="<rc_car>" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm0001_rc_car' \
  --scale_lr \
  --prompt_type='nonliving' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 1236  textual_inversion_train_mlm_single.py \
  --pretrained_model_name_or_path=$MODEL_NAME \
  --train_data_dir1=$DATA_DIR \
  --learnable_property="object" \
  --placeholder_token1="<rc_car>" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00025_rc_car' \
  --scale_lr \
  --prompt_type='nonliving' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 1236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_no_mlm_rc_car' \
  --scale_lr \
  --prompt_type='nonliving' \
  --include_prior_concept=0 
