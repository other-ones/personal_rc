...
accelerate launch --main_process_port 3234  textual_inversion_train_mlm_single.py \
  ...
  --placeholder_token1="<teddybear>" \
  --prior_concept1="teddybear" \
  --resolution=512 \
  --train_batch_size=1 \
  ...
  --lr_warmup_steps=0 \
  --output_dir="saved_models/single/teddybear" \
  --seed=7777 \
  --mask_tokens="[MASK]" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00005_teddybear' \
  --scale_lr \
...
accelerate launch --main_process_port 3235  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm0001_teddybear' \
  --scale_lr \
  --prompt_type='nonliving' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 3236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00025_teddybear' \
  --scale_lr \
  --prompt_type='nonliving' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 3236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_no_mlm_teddybear' \
  --scale_lr \
  --prompt_type='nonliving' \
  --include_prior_concept=0 
