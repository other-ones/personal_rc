...
export DATA_DIR="/data/twkim/diffusion/personalization/collected/images/pink_sunglasses"
export CUDA_VISIBLE_DEVICES=4;
accelerate launch --main_process_port 3234  textual_inversion_train_mlm_single.py \
  --pretrained_model_name_or_path=$MODEL_NAME \
  --train_data_dir1=$DATA_DIR \
  --learnable_property="object" \
  --placeholder_token1="<pink_sunglasses>" \
  --prior_concept1="sunglasses" \
  --resolution=512 \
  --train_batch_size=1 \
  ...
  --lr_warmup_steps=0 \
  --output_dir="saved_models/single/pink_sunglasses" \
  --seed=7777 \
  --mask_tokens="[MASK]" \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00005_pink_sunglasses' \
  --scale_lr \
  --prompt_type='sunglasses' \
...
accelerate launch --main_process_port 3235  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm0001_pink_sunglasses' \
  --scale_lr \
    --prompt_type='sunglasses' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 3236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_mlm00025_pink_sunglasses' \
  --scale_lr \
  --prompt_type='sunglasses' \
  --include_prior_concept=0 
...
accelerate launch --main_process_port 3236  textual_inversion_train_mlm_single.py \
  ...
  --mlm_target='masked' \
  --mlm_batch_size=50 \
  --run_name='ti_noprior_no_mlm_pink_sunglasses' \
  --scale_lr \
    --prompt_type='sunglasses' \
  --include_prior_concept=0 
