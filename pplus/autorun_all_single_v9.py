...
if train_batch_size==4:
    ...
    assert False
if include_prior:
    dir_name=f'capv9_prior_seed{seed}_qlab{host_suffix}_rep{rep_id}'
else:
    dir_name=f'capv9_noprior_seed{seed}_qlab{host_suffix}_rep{rep_id}'
                ...
                for mlm_target in mlm_target_list:
                    ...
                    for cidx,concept in enumerate(list(info_map.keys())):
                        ...
                        for lambda_mlm in lambda_mlm_list:
                            ...
                            prefix='pplus_bigger_qlab{}'.format(host_suffix)
                            if include_prior:
                                prefix+='_prior'
                            else:
                                prefix+='_noprior'
                            ...
                            command+='--caption_root="../datasets_pkgs/captions/v9" \\\n'
                            command+='--run_name="{}" \\\n'.format(run_name)
