...
if include_prior:
    dir_name=f'gclip_reduced4_prior_seed{seed}_qlab{host_suffix}_rep{rep_id}'
else:
    dir_name=f'gclip_reduced4_noprior_seed{seed}_qlab{host_suffix}_rep{rep_id}'
                ...
                for mlm_target in mlm_target_list:
                    ...
                    for cidx,concept in enumerate(list(info_map.keys())):
                        ...
                        for lambda_mlm in lambda_mlm_list:
                            ...
                            prefix='pplus_gclip_qlab{}'.format(host_suffix)
                            if include_prior:
                                prefix+='_prior'
                            else:
                                prefix+='_noprior'
