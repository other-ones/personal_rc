...
from consts_v5 import HUMAN_INTERACTIONS,NONLIVINGS,COLORS,HUMANS,RELATIVES,STYLES,BACKGROUNDS
from consts_v5 import OUTFITS,WEARINGS
import shutil


if __name__=='__main__':
    dst_root='../../captions/v5_simple/pet'
