...
from consts_v7 import HUMAN_INTERACTIONS,NONLIVINGS,COLORS,HUMANS,RELATIVES,STYLES,BACKGROUNDS
from consts_v7 import OUTFITS,WEARINGS
from consts_v7 import NONVLIVING_INTERACTIONS_ACTIVE,SHAPES
import shutil


if __name__=='__main__':
    dst_root='../../captions/v7/pet'
