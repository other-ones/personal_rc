...
if __name__=='__main__':
    ...
    for concept in concepts:
        ...
        real_root=os.path.join('/data/twkim/diffusion/personalization/collected/masked_bg/',concept)
        concept_results=[]
        ...
        if True:
            for exp in sorted_exps:
                ...
                if args.exclude_attr_change:
                    ...
                    exclude_list=None
                score_name='masked_dino_bg'
                fake_root=os.path.join(exp_path,'masked_bg')
