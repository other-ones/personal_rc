...
try:
    ...
    from .pipeline_stable_diffusion_ref import StableDiffusionPipelineRef
    from .pipeline_stable_diffusion_aux_guidance import StableDiffusionPipelineAuxiliaryGuidance
    ...
    from .pipeline_stable_diffusion_noref import StableDiffusionPipelineNoRef
