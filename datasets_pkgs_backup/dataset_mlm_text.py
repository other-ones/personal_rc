...
class MLMDataset(Dataset):
    ...
    def __init__(
        ...
        #         continue
        #     aug_cap_files=os.listdir(os.path.join(aug_root,cap_type))
        #     if cap_type not in self.aug_captions:
        #         self.aug_captions[cap_type]={}
        #     for aug_cap_file in aug_cap_files:
        #         aug_cap_lines=open(os.path.join(aug_root,cap_type,aug_cap_file)).readlines()
        #         for line in aug_cap_lines:
        #             assert '<new1>' in line
    ...
    def __getitem__(self, index):
        ...
        #     if sampled_type=='pet':
        #         placeholder=np.random.choice(['cat','dog','hamster','Guinea Pig','pig','Hedgehog','Labrador Retriever','Poodle','Greyhound'])
        #     elif sampled_type=='nonliving':
        #         placeholder=np.random.choice(['vase','rc car','pot','vase','bottle','chair','table','lamp','plate','clock','book','pen','pencil','candle','curtain','remote control','teddy bear','wallet','statue','notebook'])
        #     elif sampled_type=='flower':
        #         placeholder='flower'
        #     elif sampled_type=='building':
        #         placeholder='barn'
        #     elif sampled_type=='sunglasses':
        ...
        #     sampled_caption=mlm_prefix.format(sampled_caption)
