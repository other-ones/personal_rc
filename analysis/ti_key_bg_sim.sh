...
accelerate launch --main_process_port 1234  ti_key_bg_sim.py \
  ...
  --prior_concept1="cat" \
  --learned_embed_path1="saved_models/ti_models/singlev2_noprior_seed2940/cat1/tiv2_noprior_mlm0001_cat1_mprob025/checkpoints/learned_embeds_s3000.pt" \
...
accelerate launch --main_process_port 1234  ti_key_bg_sim.py \
  ...
  --placeholder_token1="<cat1>" \
  --prior_concept1="cat" \
  --learned_embed_path1="saved_models/ti_models/singlev2_noprior_seed2940/cat1/tiv2_noprior_nomlm_cat1/checkpoints/learned_embeds_s3000.pt" \
  --include_prior_concept=0 \
  --target='prior' \
  --run_name='cat1_nomlm' \
