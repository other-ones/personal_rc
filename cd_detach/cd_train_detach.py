...
from datasets_pkgs.dataset_cd_clean import CustomDiffusionDataset
...
def main(args):
    ...
    del st
    # for key in custom_diffusion_attn_procs:
    #     print(key,'custom_diffusion_attn_procs') # attn1/attn2
    # print('\n')

    unet.set_attn_processor(custom_diffusion_attn_procs)
    # for key in unet.attn_processors.keys():
    #     print(key,'unet.attn_processors.key') # attn1/attn2
    # print('\n')

    custom_diffusion_layers = AttnProcsLayers(unet.attn_processors)
    # print(custom_diffusion_layers,'custom_diffusion_layers') # no_attn1
    # print('\n')
    # unet.attn_processors.key() : e.g., up_blocks.3.attentions.2.transformer_blocks.0.attn2.processor
