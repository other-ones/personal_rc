...
rep_id=999
detach_bos=1
dir_name=f'detach{detach_bos}_seed{seed}_qlab{host_suffix}_rep{rep_id}'
        ...
        for mask_prob in mask_prob_list:
            ...
            for concept_idx,concept in enumerate(list(info_map.keys())):
                for check_tag in check_tags:        
                    ...
                    run_name='cd_detach_qlab{}'.format(host_suffix)
                    if lambda_mlm:
                    ...
                    command+='accelerate launch --main_process_port {} cd_train_detach.py \\\n'.format(ports[port_idx])
