...
class AttendExciteAttnProcessor:
    ...
    def __call__(self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None,attn_mod_params=None):
        ...
        attention_probs = attn.get_attention_scores(query, key, attention_mask) #at attention_processors.py

        # # Attn Modulation
        # if is_cross and attn_mod_params is not None:
        ...
        #     pos_masks_batch=torch.repeat_interleave(pos_masks_batch,num_heads,dim=0) # Check here
        #     if do_classifier_free_guidance:
        ...
        #         # Update scores
        #         cond_scores=cond_scores+((offset_pos*(pos_masks_batch>0))*(treg))
