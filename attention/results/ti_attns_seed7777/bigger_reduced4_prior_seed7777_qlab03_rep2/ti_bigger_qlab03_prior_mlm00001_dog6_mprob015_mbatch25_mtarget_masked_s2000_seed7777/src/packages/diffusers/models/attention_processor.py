...
class Attention(nn.Module):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None,attn_mod_params=None, **cross_attention_kwargs):
        # The `Attention` class can call different attention processors / attention functions
        # here we simply pass along all tensors to the selected processor class
        # For standard processors that are defined here, `**cross_attention_kwargs` is empty
        # import inspect
        # print(self.processor,'self.processor')
        # print(inspect.getfile(self.processor.__class__),'file')


        # print(attn_mod_param,'attn_mod_param')
    ...
    def batch_to_head_dim(self, tensor):
        ...
        # e.g., 10,4096,77 -> 2,10,4096,77 -> 2,4096,10,77 -> 2,4096,770
    ...
    def get_attention_scores(self, query, key, attention_mask=None,attn_mod_params=None):
        dtype = query.dtype
...
class AttnProcessor:
    ...
    def __call__(
        ...
        # print(hidden_states.shape,'hidden_states.shape attnExcite')
        # print(encoder_hidden_states.shape,'encoder_hidden_states.shape attnExcite')
        # print(query.shape,'query.shape attnExcite')
        # print(key.shape,'key.shape attnExcite')
        # print(value.shape,'value.shape attnExcite')
