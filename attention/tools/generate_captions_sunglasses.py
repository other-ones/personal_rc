...
if __name__=='__main__':
    ...
    for subject in LIVINGS:
        ...
        for act in SUNGLASSES_ACTIVITIES:
            prompt1=f"{subject} wearing <new1> {act}"
    ...
    print('INTERACTIONS:',len(captions_sunglasses_human_interactions),captions_sunglasses_human_interactions[:5])
    print()
    print('RELATIVES:',len(captions_sunglasses_relations),captions_sunglasses_relations[:5])
    print()
    print('BG:',len(captions_sunglasses_bg),captions_sunglasses_bg[:5])
    print()
    print('STYLE:',len(captions_sunglasses_style),captions_sunglasses_style[:5])
    print()
    print('ATTR:',len(captions_sunglasses_attr),captions_sunglasses_attr[:5])
    print()
    print('WEAR:',len(captions_sunglasses_wearing),captions_sunglasses_wearing[:5])
    print()
