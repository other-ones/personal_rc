...
export OUTPUT_DIR="saved_models/cd_models/single/duck_toy";
export CUBLAS_WORKSPACE_CONFIG=:4096:8;
export INSTANCE_DIR="/data/twkim/diffusion/personalization/collected/images/duck_toy";
...
accelerate launch --main_process_port=9980 cd_train.py \
  ...
  --resume_cd_path='saved_models/cd_models/single_capv7_seed7777_rep1/duck_toy/cd_cnetv4_nomlm_duck_toy_fixte_lr1e5/checkpoints/checkpoint-500/custom_diffusion.pt' \
  --learned_embed_path1='saved_models/cd_models/single_capv7_seed7777_rep1/duck_toy/cd_cnetv4_nomlm_duck_toy_fixte_lr1e5/checkpoints/checkpoint-500/learned_embeds.pt'