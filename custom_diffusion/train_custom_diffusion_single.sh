...
accelerate launch --main_process_port=9980 train_custom_diffusion_single.py \
  ...
  --prior_concept1="cat" \
  --prompt_type="pet" \
  --run_name="pet_cat1_nomlm" \
  --mlm_target="masked"


export MODEL_NAME="runwayml/stable-diffusion-v1-5";
export OUTPUT_DIR="saved_models/custom_diffusion/single/pet_dog1";
export INSTANCE_DIR="/data/twkim/diffusion/personalization/collected/images/pet_dog1";
export CUDA_VISIBLE_DEVICES=2,3;
accelerate launch --main_process_port=9982 train_custom_diffusion_single.py \
  --pretrained_model_name_or_path=$MODEL_NAME  \
  --train_data_dir1=$INSTANCE_DIR \
  --output_dir=$OUTPUT_DIR \
  --resolution=512  \
