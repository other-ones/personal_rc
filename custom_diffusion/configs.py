...
def parse_args(input_args=None):
    ...
    parser.add_argument('--resume_cd_path',type=str)
    ...
    parser.add_argument("--simple_caption",type=float,default=0)
    ...
    parser.add_argument("--train_text_encoder",type=int,default=0)
    ...
    parser.add_argument('--initialize_token',default=1,type=int)
