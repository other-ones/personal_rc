...
import transformers
import diffusers
print(diffusers.__version__,'diffusers')
...
sys.path.append('./')
from diffusers_model_pipeline import CustomDiffusionAttnProcessor, CustomDiffusionPipeline, set_use_memory_efficient_attention_xformers
from diffusers_data_pipeline import CustomDiffusionDataset, PromptDataset, collate_fn
