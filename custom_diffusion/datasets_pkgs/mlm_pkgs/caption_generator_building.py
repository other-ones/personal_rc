...
other_objs = [
    "tractor", "fence", "windmill", "silo", "water tower", "grain silo", "barn door", "weather vane", "haystack", 
    "garden", "chicken coop", "shed", "greenhouse", "well", "pond", "barn window", "scarecrow", "barn roof", 
    "wheelbarrow", "tool shed", "barn loft", "flower bed", "vegetable patch", "barnyard gate", "feed trough", 
    "horse stable", "pasture fence", "corn field", "apple orchard", "grapevine", "woodpile", "farmhouse", "barn ladder",
    "watering can", "wooden crate", "bale of hay", "pitchfork", "birdhouse", "rusty plow", "garden bench",
    "mailbox", "lamp post", "fire hydrant", "bench", "tree", "statue", "fountain", "bus stop", "street sign", 
    "park bench", "bike rack", "street lamp", "garbage can", "recycling bin", "planter", "vending machine", "billboard",
    "newspaper stand", "parking meter", "public art sculpture", "phone booth", "public restroom", "drinking fountain",
    "street vendor cart", "outdoor cafe table", "railway crossing sign", "loading dock", "garage door", "parking lot",
    "construction crane", "traffic cone", "traffic light", "manhole cover", "storm drain", "subway entrance", 
    "electric vehicle charging station", "bird feeder", "community bulletin board", "picnic table", "park gazebo",
    "playground slide", "sandbox", "swing set", "public garden", "street performer", "food truck", "information kiosk",
    "water feature", "historic plaque", "road barrier", "security camera", "alleyway", "dumpster", "shopping cart"
]
colors = [
