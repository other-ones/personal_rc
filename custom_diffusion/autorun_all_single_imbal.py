...
for imbalance in imbalance_list:
    dir_name=f'imbal{imbalance}_seed{seed}_qlab{host_suffix}_rep{rep_id}'
            ...
            for mask_prob in mask_prob_list:
                ...
                for concept_idx,concept in enumerate(list(info_map.keys())):
                    for check_tag in check_tags:        
                        ...
                        run_name=f'cd_imbal{imbalance}_qlab{host_suffix}'
                        if lambda_mlm:
                        ...
                        command+='accelerate launch --main_process_port {} cd_train_imbal.py \\\n'.format(ports[port_idx])
                        ...
                        command+='--checkpoints_total_limit={} \\\n'.format(base_limit*imbalance)
                        command+='--max_train_steps={} \\\n'.format(base_max_steps*imbalance+1)
                        ...
                        command+='--project_name="CD MLM Imbalance" \\\n'
