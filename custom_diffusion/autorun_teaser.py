...
gen_seed=6804
rep_id=2
dir_name='init_seed{}_qlab{}_rep{}'.format(resume_seed,host_suffix,rep_id)
...
for gen_target_step in [500]:
    for concept_idx,concept in enumerate(concepts):
        ...
        for exp_idx,exp in enumerate(exps):
            ...
            output_dir=os.path.join('results/teasers/{}_seed{}/cd_results/{}/{}'.format(benchmark,gen_seed,dir_name,concept))
            ...
            print(f'{benchmark}\t{output_dir}\t{device_idxs}')
            ...
            command+='accelerate launch --main_process_port {} cd_generate_teaser.py \\\n'.format(ports[port_idx])
